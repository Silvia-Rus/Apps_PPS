...
const HomeScreen = () => {
  ...
  const setAnimalsSpanish = () => {
    setImage1(require("../../assets/animals/tiger.png"));
    ...
    setImage9(require("../../assets/animals/rabbit.png"));

    setSound1(require("../../assets/sounds/spanish/animals/tigre.mp3"));
    ...
    setSound9(require("../../assets/sounds/spanish/animals/conejo.mp3"));
  };

  const setAnimalsEnglish = () => {
    setImage1(require("../../assets/animals/tiger.png")); //OK
    setImage2(require("../../assets/animals/cat.png")); //OK
    setImage3(require("../../assets/animals/cow.png")); // OK
    setImage4(require("../../assets/animals/dog.png")); // OK
    setImage5(require("../../assets/animals/elephant.png")); // OK
    setImage6(require("../../assets/animals/penguin.png"));
    setImage7(require("../../assets/animals/lion.png"));
    setImage8(require("../../assets/animals/owl.png"));
    setImage9(require("../../assets/animals/rabbit.png"));

    setSound1(require("../../assets/sounds/english/animals/tiger.mp3"));
    ...
    setSound9(require("../../assets/sounds/english/animals/rabbit.mp3"));
  };
  ...
  const setAnimalsPortuguese = () => {
    ...
    setImage8(require("../../assets/animals/owl.png"));
    setImage9(require("../../assets/animals/rabbit.png"));
    setSound1(require("../../assets/sounds/portuguese/animals/tigre.mp3"));
    ...
    setSound9(require("../../assets/sounds/portuguese/animals/coelho.mp3"));
  };
