...
const HomeScreen = () => {
    ...
    if (permission) {
        return (
            <ImageBackground source={require('../../assets/backgroundHome.png')} resizeMode="repeat" style={styles.image}>
                ...
                <View style={styles.container}>            
                    ...
                    <Text style={styles.textPreTitleHome}>{auth?.currentUser?.email}</Text>
                    <Text style={styles.textTitleHome}>Saldo:</Text>
