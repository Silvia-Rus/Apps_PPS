...
const CameraScreen = () => {
  ...
  const uploadImage = async (image: any, type: string) => {
    ...
    await addDoc(collection(db, "images"), {
      ...
      //link: auth?.currentUser?.photoURL,
      //images/32ba27b2-c314-4590-96fb-b1bd1c47ecda.jpeg
      //https://firebasestorage.googleapis.com/v0/b/appmovil-42850.appspot.com/o/images%
      //2F4142a1c6-9b85-4db0-a096-133d57214601.jpeg?
      //alt=media&token=1ed2cfb2-e6a1-4368-83e9-4e59a8229e9e
    });
