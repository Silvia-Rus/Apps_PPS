...
const GraphicScreen = () => {
    ...
    const getNiceFotos = async () => {
        try {
            resetData();
            const querySnapshot = await (await getDocs(query(collection(db, "images"), orderBy('creationDate', 'desc')))); 
            //declaramos un array
            let fotosNice:any = [];
    ...
    return(
        <ImageBackground source={require('../assets/background.jpg')} resizeMode="repeat" style={styles.image}>
            ...
            <TouchableOpacity
                ...
                >
            <Text style={styles.TextCharts}>Cosas Feas</Text>
            ...
            <BarChart
                ...
                <TouchableOpacity
                    ...
                    style={styles.chartPie}
                >
                     <Text style={styles.TextCharts}>Cosas Lindas</Text>
                <PieChart
                        data={arrNice}
                        width={350}
                        height={150}
