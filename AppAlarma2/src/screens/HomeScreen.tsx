    ...
    if (start) {
      switch (position) {
        case 'horizontal':
          ...
          playSound(require('../../assets/sounds/horizontal.m4a'));

          Vibration.vibrate(5000);
          break;
        case 'izquierda':
          //playSound(require('../../assets/sounds/alarm2.mp3'));
          playSound(require('../../assets/sounds/izquierda.m4a'));

          break;
        case 'derecha':
          //playSound(require('../../assets/sounds/alarm3.mp3'));
          playSound(require('../../assets/sounds/derecha.m4a'));
          break;
        case 'vertical':
          //playSound(require('../../assets/sounds/alarm4.mp3'));
          playSound(require('../../assets/sounds/vertical.m4a'));
  ...
  return (
    ...
    >
      <View style={styles.container}>
        {subscription && position === "vertical" && <Camera flashMode={FlashMode.torch} style={{ height: 1, width: 1 }}
        ></Camera>}
          ...
          {modal ? (
            <View style={{ flexDirection: 'column', alignContent: 'center', alignItems: 'center' }} >
              ...
              <View style={styles.input}>
                <FontAwesome name="bell-slash" size={24} color="#d11174" />
                <TextInput
                  placeholder="Confirme contraseña..."
                  placeholderTextColor="#d11174"
            ...
            <Text style={styles.buttonText}>Pulsa sobre el gatito para empezar a usar la alarma</Text>
          }
        </View>
      </View>
    </ImageBackground>
